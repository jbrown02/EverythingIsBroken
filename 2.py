...
# get list of files
playlist = listdir("/Users/joshuabrown/Music/iTunes/iTunes Media/Music/Animals as Leaders/The Joy of Motion")
...
def start_music():
    ...
    while not mixer.music.get_busy() and not is_stopped and not is_paused and not is_started:
        mixer.music.load(f"/Users/joshuabrown/Music/iTunes/iTunes Media/Music/Animals as Leaders/The Joy of Motion/{active_playlist.__getitem__(indexed_track)}")
        mixer.music.play()
        is_started = True
